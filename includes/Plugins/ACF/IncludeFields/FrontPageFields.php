			...
			array(
				...
				'sub_fields'   => array(
					...
					array(
						...
						'sub_fields' => array(
							...
							array(
								...
								'instructions'  => __( 'Main heading of the page (H1). Plain text only, no accent colour on a word.', 'agencecinq' ),
								'default_value' => '',
							),
						),
					),
					...
					array(
						...
						'aria-label'   => __( 'Specs', 'agencecinq' ),
						'type'         => 'repeater',
						'instructions' => __( 'Up to 4 items. Each line is a muted prefix plus an optional accent highlight.', 'agencecinq' ),
						'layout'       => 'block',
						'max'          => 4,
						...
						'sub_fields'   => array(
							...
							array(
								...
								'instructions'    => '<em>' . __( 'Optional. Rendered in accent colour.', 'agencecinq' ) . '</em>',
								'wrapper'         => array(
									'width' => 6 * 100 / 12,
								),
								'parent_repeater' => 'field_' . $key . '_hero_specs',
