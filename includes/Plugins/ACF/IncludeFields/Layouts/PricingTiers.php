				...
				array(
					...
					'sub_fields'   => array(
						array(
							...
							'type'            => 'true_false',
							'default_value'   => 0,
							'message'         => __( 'Highlight this tier (pistachio border, soft fill, and badge).', 'agencecinq' ),
						...
						array(
							...
							'instructions'      => __( 'Uppercase mono label on the featured card.', 'agencecinq' ),
							'conditional_logic' => array(
								array(
									array(
										'field'    => 'field_' . $key . '_pricing_tiers_items_featured',
										'operator' => '==',
										'value'    => '1',
									),
								),
