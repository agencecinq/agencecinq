						...
						array(
							...
							'sub_fields'   => array(
								...
								array(
									...
									'type'            => 'select',
									'choices'         => array(
										'bg-page'  => __( 'Page', 'agencecinq' ),
										'bg-elevated' => __( 'Élevé', 'agencecinq' ),
										'bg-card' => __( 'Carte', 'agencecinq' ),
										'bg-card-hover' => __( 'Carte · survol', 'agencecinq' ),
										'bg-accent'     => __( 'Accent', 'agencecinq' ),
									),
									'default_value'   => 'bg-card',
									'parent_repeater' => 'field_' . $key . '_grid_content_items',
									'return_format'   => 'value',
									'wrapper'         => array(
										'width' => 4 * 100 / 12,
								...
								array(
									...
									'type'            => 'select',
									'choices'         => array(
										'text-primary'  => __( 'Principal', 'agencecinq' ),
										'text-muted'    => __( 'Atténué', 'agencecinq' ),
										'text-on-accent' => __( 'Sur accent', 'agencecinq' ),
									),
