						...
						array(
							...
							'sub_fields'   => array(
								...
								array(
									...
									'type'            => 'select',
									'choices'         => array(
										'bg-black'       => __( 'Black', 'agencecinq' ),
										'bg-dark-gray'   => __( 'Dark gray', 'agencecinq' ),
										'bg-gray'        => __( 'Gray', 'agencecinq' ),
										'bg-medium-gray' => __( 'Medium gray', 'agencecinq' ),
										'bg-pistachio'   => __( 'Pistachio', 'agencecinq' ),
									),
								...
								array(
									...
									'type'            => 'select',
									'choices'         => array(
										'text-cream'     => __( 'Cream', 'agencecinq' ),
										'text-taupe'     => __( 'Taupe', 'agencecinq' ),
										'text-off-black' => __( 'Off-black', 'agencecinq' ),
									),
									'default_value'   => 'text-cream',
									'parent_repeater' => 'field_' . $key . '_grid_content_items',
									'return_format'   => 'value',
									'wrapper'         => array(
										'width' => 4 * 100 / 12,
								...
								array(
									...
									'type'            => 'select',
									'choices'         => array(
										'text-pistachio' => __( 'Pistachio', 'agencecinq' ),
										'text-cream'     => __( 'Cream', 'agencecinq' ),
										'text-off-black' => __( 'Off-black', 'agencecinq' ),
									),
									'default_value'   => 'text-pistachio',
									'parent_repeater' => 'field_' . $key . '_grid_content_items',
									'return_format'   => 'value',
									'wrapper'         => array(
										'width' => 4 * 100 / 12,
